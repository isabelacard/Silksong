    ...
    const cards: CardItem[] = [
        {
            ...
            content: (
                <div className="h-full w-full bg-[#000000] rounded-2xl p-[6vh] flex flex-col justify-center text-[#ffffff] relative overflow-hidden">
                    ...
                    <p style={{ fontFamily: "Poppins", fontWeight: "400" }} className="text-[20px] mt-6 max-w-[70%] leading-snug">
                        The highly anticipated sequel to the legendary Hollow Knight. A frantic ascent filled with silk, song, precision, and creatures both beautiful… and terrifying.
                    </p>

                    <div className="mt-[10vh]">
                        <button
                            style={{ fontFamily: "Trajan Pro", fontWeight: "bold" }}
                            className="relative border-2 border-white group px-10 py-4 text-white font-bold text-2xl flex items-center justify-center gap-3 shadow-[0_0_20px_#c42b32aa] transition-all duration-300 hover:shadow-[0_0_35px_#ff3b3baa] hover:brightness-125"
                        >
                            More information
            ...
            content: (
                <div className="h-full w-full bg-[#12080b] rounded-2xl p-[6vh] flex flex-col justify-center text-[#ffffff] overflow-y-auto">
                    ...
                    <div className="space-y-7 text-xl opacity-90 pr-4">
                        <div>
                            <h3 style={{ fontFamily: "Poppins", fontWeight: "800" }} className="text-[18px] font-semibold">
                                Does it have a release date?
                            </h3>
                            <p style={{ fontFamily: "Poppins", fontWeight: "400" }} className="text-[17px]">
                                Yes, September 4th, 2025.
                            </p>
                        </div>

                        <div>
                            <h3 style={{ fontFamily: "Poppins", fontWeight: "800" }} className="text-[18px] font-semibold">
                                Will it be harder than Hollow Knight?
                            </h3>
                            <p style={{ fontFamily: "Poppins", fontWeight: "400" }} className="text-[17px]">
                                The studio has said Hornet is more agile, so combat will be faster and more challenging.
                            </p>
                        </div>

                        <div>
                            <h3 style={{ fontFamily: "Poppins", fontWeight: "800" }} className="text-[18px] font-semibold">
                                Is it an expansion of the first game?
                            </h3>
                            <p style={{ fontFamily: "Poppins", fontWeight: "400" }} className="text-[17px]">
                                No. It is a completely new game with more content than the original.
                            </p>
                        </div>

                        <div>
                            <h3 style={{ fontFamily: "Poppins", fontWeight: "800" }} className="text-[18px] font-semibold">
                                Does it keep the metroidvania exploration style?
                            </h3>
                            <p style={{ fontFamily: "Poppins", fontWeight: "400" }} className="text-[17px]">
                                Absolutely. New vertical zones, more complex biomes, and dynamic shortcuts.
                            </p>
                        </div>

                        <div>
                            <h3 style={{ fontFamily: "Poppins", fontWeight: "800" }} className="text-[18px] font-semibold">
                                Will Hornet have new abilities?
                            </h3>
                            <p style={{ fontFamily: "Poppins", fontWeight: "400" }} className="text-[17px]">
                                Yes — mobility-focused skills, tools, traps, and crafting systems.
                            </p>
                        </div>
                    </div>
                </div>
...

        {
            ...
            content: (
                <div className="h-full w-full bg-[#110809] rounded-2xl p-[6vh] flex flex-col justify-center text-[#ffffff]">
                    ...
                    <ul className="mt-[6vh] text-3xl opacity-95 grid grid-cols-2 gap-y-4">
                        {/* Columna izquierda */}
...

        {
            ...
            content: (
                <div className="h-full w-full bg-black rounded-2xl p-[6vh] flex flex-col justify-center text-[#ffffff] relative">
                    ...
                    <button
                        style={{ fontFamily: "Trajan Pro", fontWeight: "bold" }}
                        className="relative border-2 border-white mt-[10vh] group w-[22vw] py-[1.3vh] text-white font-bold text-center flex items-center justify-center gap-3 shadow-[0_0_30px_#c42b32aa] transition-all duration-300 hover:shadow-[0_0_55px_#ff3b3baa] hover:brightness-125"
                    >
